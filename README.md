...
**Run Windows Steam games on macOS with Metal. No VM, no external runtime, no GPTK. Just play.**
...
a single macOS app — no Game Porting Toolkit or external runtime required.
