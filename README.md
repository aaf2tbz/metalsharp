...
| **Among Us** | Unity IL2CPP | external runtime Wine + Vulkan | Working | Working | M4, macOS 26 |
...
| Unity IL2CPP (32-bit) | Working | external runtime Wine + Vulkan renderer |
...
2. **Dependencies** — installs what's needed:
   ...
   - external runtime Wine (Among Us and other Unity 32-bit games)
...
- **external runtime** — Unity 32-bit games with built-in Vulkan renderer (Among Us)
...
- **Among Us** — initializes external runtime Wine prefix
...
# Unity IL2CPP games (external runtime Wine)
...
| 945360 | Among Us | external runtime Wine + prefix-945360 |
...
### external runtime Wine path (Unity IL2CPP)
...
├── prefix-945360/      Wine prefix for external runtime games (Among Us)
