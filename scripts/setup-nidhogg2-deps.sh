...
echo ""
ok "Nidhogg 2 CrossOver+DXVK runtime ready!"
info "Launch with: CrossOver Wine + DXVK 1.10.3 (appid $GAME_ID)"
info "No flickering, 60fps, Vulkan 1.1 compatible with CrossOver's bundled MoltenVK"
