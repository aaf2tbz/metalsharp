...
| Game | Bytecode records | Stage metallibs | Pipeline records | Linked stages | Linked source bytecodes | M12 raw bytecode overlap | Unlinked stages |
|---|---:|---:|---:|---:|---:|---:|---:|
| elden-ring | 1410 | 1503 | 1134 | 1416 | 1026 | 717 | 87 |
| armored-core-vi | 1714 | 1854 | 1649 | 1769 | 1368 | 377 | 85 |
| subnautica-2 | 10453 | 11486 | 11229 | 10138 | 9446 | 485 | 1348 |
...
- pipeline_records_with_bytecode_keys: `1625`
- pipeline_bytecode_key_refs: `3347`
...
- pipeline_records_with_bytecode_keys: `4744`
- pipeline_bytecode_key_refs: `9437`
...
- First pipeline records with bytecode keys:
  - pipeline=`012c22dd5aeef250fc6df61b742dee38` offset=`16768` refs=`vertex:ace8771b795ee838e68a00e1ec134593, pixel:1da322eb49fde1a27ed8376c74ad345b`
  - pipeline=`b9e8e173f157f0ea0887041b742dee38` offset=`16928` refs=`vertex:ace8771b795ee838e68a00e1ec134593, pixel:686d30eb5dc4d6a5a0823cd528542b79`
  - pipeline=`8289ad8c5f2b75457fc6f90d4cedfde2` offset=`17088` refs=`vertex:0febfa0d6aeff9e29fc84bb7460d6497`
  - pipeline=`d54beef547e501a7a4ceb92d7986e99d` offset=`17224` refs=`vertex:9c6fba2d5f84ed9d25e688e871b7a784`
  - pipeline=`3682b1e7d32a7fdadb4f9f9eb80674bd` offset=`17360` refs=`vertex:3b3a9c9e9e0470bde487eb8062d75b18`
  - pipeline=`a7c4fb926817ece50509b8444f05c908` offset=`17496` refs=`vertex:41b99a444276cf08ac99b634d9de7852, pixel:6fa959ee9860abe07c4f82d0ce2fedff`
  - pipeline=`e174cc638e2272595a01c942bffc73a8` offset=`17656` refs=`vertex:1a6ff942b28f75a843d91e8faa8b6a4c, pixel:d1a7f32984fd4443f1e705a6017f2826`
  - pipeline=`0b719a3e27954666a5cd3300b4c786ed` offset=`17816` refs=`vertex:05157600b9b480ed5e47bdad44b0ce30, pixel:45b3fee35bdb434a20f678235cedceb8`
  - pipeline=`a98baea56c2e2b4c09542000b4c786ed` offset=`17976` refs=`vertex:05157600b9b480ed5e47bdad44b0ce30, pixel:81a25d549e8680bab825b08daa216e5b`
  - pipeline=`9fc8273eb50f32be7d392100b4c786ed` offset=`18136` refs=`vertex:05157600b9b480ed5e47bdad44b0ce30, pixel:9ea5648ecfcbc20826cdb723286467c2`
- First linked records:
