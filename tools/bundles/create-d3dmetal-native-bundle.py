...
CONTRACT_MANIFEST = {
    ...
    "payload_layout": {
        ...
        "lib/d3dmetal_native/x86_64-windows/": "PE route DLLs (d3d10/11/12, dxgi, nvapi64, nvngx-on-metalfx; optional d3d10_1/d3d10core compatibility members when present)",
