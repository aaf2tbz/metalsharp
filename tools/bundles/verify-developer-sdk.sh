...
required=(
  ...
  "$ROOT/runtime/dxmt/x86_64-windows/nvapi64.dll"
  "$ROOT/runtime/dxmt/x86_64-windows/nvngx.dll"
  "$ROOT/runtime/dxmt/x86_64-unix/winemetal.so"
  "$ROOT/runtime/dxmt/x86_64-unix/libc++.1.dylib"
  "$ROOT/runtime/dxmt/x86_64-unix/libc++abi.1.dylib"
  "$ROOT/runtime/dxmt/x86_64-unix/libunwind.1.dylib"
  "$ROOT/scripts/run-probes.sh"
  "$ROOT/scripts/m12-dev.sh"
  "$ROOT/scripts/stage-dxmt-runtime.py"
  "$ROOT/scripts/stage-game-metal-validation.py"
