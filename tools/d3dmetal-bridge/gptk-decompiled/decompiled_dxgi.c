...
void __wine_spec_relay_entry_point_4(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4)
...

{
    if (fdwReason == 0) {
        ...
        gTrampolineThread = CreateThread((LPSECURITY_ATTRIBUTES)0x0, 0, Thunk_Thread, gGFXTDispatch.GFXT_ThreadContext,
                                         0, (LPDWORD)0x0);
    }
    return 1;
}
...
HRESULT DXGID3D10CreateDevice(HMODULE d3d11, void* factory, void* adapter, uint flags,
                              D3D_FEATURE_LEVEL* feature_levels, uint level_count, void** device)

{
    /* 0x12e0  4  DXGID3D10CreateDevice */
    puts("HRESULT DXGID3D10CreateDevice(HMODULE, void *, void *, unsigned int, const D3D_FEATURE_LEVEL *, unsigned "
         "int, void **)");
    return -0x7fffbffb;
}
...
LONG __stdcall ChangeDisplaySettingsExW(LPCWSTR lpszDeviceName, DEVMODEW* lpDevMode, HWND hwnd, DWORD dwflags,
                                        LPVOID lParam)
...
HANDLE __stdcall CreateEventExA(LPSECURITY_ATTRIBUTES lpEventAttributes, LPCSTR lpName, DWORD dwFlags,
...
HANDLE __stdcall CreateSemaphoreExA(LPSECURITY_ATTRIBUTES lpSemaphoreAttributes, LONG lInitialCount, LONG lMaximumCount,
...

{
    ...
    /* WARNING: Treating indirect jump as call */
    pvVar1 = CreateSemaphoreExA(lpSemaphoreAttributes, lInitialCount, lMaximumCount, lpName, dwFlags, dwDesiredAccess);
    return pvVar1;
}

/* CreateThread at 0x180001470 */

HANDLE __stdcall CreateThread(LPSECURITY_ATTRIBUTES lpThreadAttributes, SIZE_T dwStackSize,
...
BOOL __stdcall DuplicateHandle(HANDLE hSourceProcessHandle, HANDLE hSourceHandle, HANDLE hTargetProcessHandle,
...

{
    ...
    /* WARNING: Treating indirect jump as call */
    BVar1 = DuplicateHandle(hSourceProcessHandle, hSourceHandle, hTargetProcessHandle, lpTargetHandle, dwDesiredAccess,
...
LSTATUS __stdcall RegCreateKeyExA(HKEY hKey, LPCSTR lpSubKey, DWORD Reserved, LPSTR lpClass, DWORD dwOptions,
...

{
    ...
    /* WARNING: Treating indirect jump as call */
    LVar1 = RegCreateKeyExA(hKey, lpSubKey, Reserved, lpClass, dwOptions, samDesired, lpSecurityAttributes, phkResult,
                            lpdwDisposition);
    return LVar1;
}
...
LSTATUS __stdcall RegQueryValueExA(HKEY hKey, LPCSTR lpValueName, LPDWORD lpReserved, LPDWORD lpType, LPBYTE lpData,
                                   LPDWORD lpcbData)
...
LSTATUS __stdcall RegSetValueExA(HKEY hKey, LPCSTR lpValueName, DWORD Reserved, DWORD dwType, BYTE* lpData,
                                 DWORD cbData)
