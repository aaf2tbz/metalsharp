...
void __wine_spec_relay_entry_point_2(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4)
...
void __wine_spec_relay_entry_point_3(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4)
...
HRESULT D3D11CreateDevice(IDXGIAdapter* adapter, D3D_DRIVER_TYPE driverType, HMODULE software, UINT Flags,
                          D3D_FEATURE_LEVEL* features, UINT numFeatures, UINT SDKVersion, ID3D11Device** ppDevice,
                          D3D_FEATURE_LEVEL* outFeatureLevel, ID3D11DeviceContext** immediateContext)

{
    ...
    HVar1 = (*gGFXTDispatch.D3D11CreateDevice)(adapter, driverType, software, Flags, features, numFeatures, SDKVersion,
                                               ppDevice, outFeatureLevel, immediateContext);
    return HVar1;
}
...

{
    ...
    /* WARNING: Treating indirect jump as call */
    HVar1 = (*gGFXTDispatch.D3D11CreateDeviceAndSwapChain)(pAdapter, DriverType, Software, Flags, pFeatureLevels,
...
HRESULT D3D11On12CreateDevice(IUnknown* pDevice, UINT Flags, D3D_FEATURE_LEVEL* pFeatureLevels,
