...
HRESULT WINAPI D3D12SerializeRootSignature(const void *a, unsigned b, void *c, void *d) {
    ...
    if (g_unix_call) return g_unix_call(3, args);
    return E_FAIL;
}
