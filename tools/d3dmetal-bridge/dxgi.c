...
HRESULT WINAPI DXGID3D10CreateDevice(void) { return call(4, NULL); }
HRESULT WINAPI DXGID3D10RegisterLayers(void) { return call(5, NULL); }
HRESULT WINAPI DXGIGetDebugInterface1(UINT a, REFIID b, void** c) {
    struct { UINT a; REFIID b; void** c; } args = {a, b, c};
    return call(6, &args);
}
HRESULT WINAPI DXGIDeclareAdapterRemovalSupport(void) { return call(7, NULL); }
