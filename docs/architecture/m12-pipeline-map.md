...
- `Graphics/dll/dxmt_m12`: the updated M12 surface used only by M12, including
...
| Deployed runtime parity | Split surface | M9/M10/M11 stay on the known-good `dxmt` surface while M12 uses the updated release-hosted `dxmt_m12` surface. |
