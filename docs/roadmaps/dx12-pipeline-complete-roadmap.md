...
**Current PR head:** latest pushed Phase 14 hardening head
...
| Phase 14 hardening head | Phase 14 hardening | PR CI green after hardening; local `./BUILD.sh && ./RUN.sh` rerun stable at DXIL 766/766 and Metal 735/766; no Phase 14 regression |
