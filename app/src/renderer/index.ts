...
class App {
  ...
  private async renderSetupInstall(container: HTMLElement) {
    ...
    if (!hasBrew) {
      ...
      depBtn.innerHTML = `<span class="setup-install-btn-label">Install Dependencies</span><span class="setup-install-btn-desc">external runtime, GPTK, Mono, DXVK, SteamCMD, and more</span>`;
      ...
      depBtn.id = "btn-install-deps";
      depBtn.innerHTML = `<span class="setup-install-btn-label">Install Dependencies</span><span class="setup-install-btn-desc">external runtime, GPTK, Mono, DXVK, SteamCMD, Wine, and more</span>`;
      buttonsDiv.appendChild(depBtn);
