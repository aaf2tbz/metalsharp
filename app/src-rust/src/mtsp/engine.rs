    ...
    PIPELINES.get_or_init(|| {
        vec![
            ...
            PipelineNode {
                ...
                experimental: false,
                requires_wine: true,
                wine_overrides: Some("d3d9=n,b;opengl32=n;gameoverlayrenderer,gameoverlayrenderer64=d"),
                dyld_paths: vec!["lib/wine/x86_64-unix", "lib/dxmt/x86_64-unix"],
                winedllpath_dirs: vec![
                    "lib/wine/x86_64-windows",
                ...
                deploy_dlls: vec![
                    ...
                    DllDeploy { source_subpath: "lib/zink/x86_64-windows", filename: "libwinpthread-1.dll", dest_filename: None },
                    DllDeploy { source_subpath: "lib/zink/i386-windows", filename: "opengl32.dll", dest_filename: None },
                    DllDeploy { source_subpath: "lib/zink/i386-windows", filename: "libgallium_wgl.dll", dest_filename: None },
                    DllDeploy { source_subpath: "lib/zink/i386-windows", filename: "libwinpthread-1.dll", dest_filename: None },
                ],
                env_vars: vec![
                    EnvVar { key: "DXMT_METALFX_SPATIAL_SWAPCHAIN", value: "1" },
                    EnvVar { key: "DXMT_ASYNC_PIPELINE_COMPILE", value: "1" },
