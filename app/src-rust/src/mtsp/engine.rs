    ...
    PIPELINES.get_or_init(|| {
        vec![
            ...
            PipelineNode {
                ...
                name: "D3DMetal",
                description: "D3D12 -> Metal via Apple D3DMetal.framework (Rosetta)",
                backend: "d3dmetal",
...
impl PipelineId {
    ...
    pub fn from_str_flexible(s: &str) -> Option<PipelineId> {
        ...
        match normalized.as_str() {
            ...
            "m13" | "gptk" => Some(PipelineId::M13),
            "d3dmetal" | "steam_d3dmetal" | "apple_d3dmetal" => Some(PipelineId::D3DMetal),
