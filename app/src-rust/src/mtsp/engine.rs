    ...
    PIPELINES.get_or_init(|| {
        vec![
            ...
            PipelineNode {
                ...
                requires_wine: true,
                wine_overrides: Some(
                    "d3d12,dxgi,EOSSDK-Win64-Shipping=n,b;gameoverlayrenderer,gameoverlayrenderer64=d",
                ),
                dyld_paths: vec![
                    "lib/gptk/x86_64-unix",
                    "lib/gptk/external",
                    "lib/gptk/external/D3DMetal.framework/Versions/A",
                    "lib/gptk/external/D3DMetal.framework/Versions/A/Resources",
                ...
                env_vars: vec![EnvVar { key: "D3DM_ENABLE_METALFX", value: "1" }],
                launch_args: vec![],
                alternatives: vec![PipelineId::M12, PipelineId::M11, PipelineId::Steam, PipelineId::MacSteam],
...
impl PipelineId {
    pub fn from_legacy_method(method: &str) -> Option<PipelineId> {
        match method.trim().to_ascii_lowercase().as_str() {
            ...
            "gptk" | "d3dmetal" | "steam_d3dmetal_gptk" => Some(PipelineId::M13),
    ...
    pub fn from_str_flexible(s: &str) -> Option<PipelineId> {
        ...
        match normalized.as_str() {
            ...
            "m13" | "gptk" | "d3dmetal" => Some(PipelineId::M13),
