...
constexpr UINT D3D12_RESOURCE_STATE_PRESENT = D3D12_RESOURCE_STATE_COMMON;
...
constexpr UINT D3D_ROOT_SIGNATURE_VERSION_1_0 = 0x1;
...
constexpr UINT DXGI_FORMAT_R32G32B32A32_TYPELESS = 1;
constexpr UINT DXGI_FORMAT_R32G32B32A32_FLOAT = 2;
constexpr UINT DXGI_FORMAT_R32G32B32A32_UINT = 3;
constexpr UINT DXGI_FORMAT_R32G32B32A32_SINT = 4;
constexpr UINT DXGI_FORMAT_R32G32B32_TYPELESS = 5;
constexpr UINT DXGI_FORMAT_R32G32B32_FLOAT = 6;
constexpr UINT DXGI_FORMAT_R32G32B32_UINT = 7;
constexpr UINT DXGI_FORMAT_R32G32B32_SINT = 8;
constexpr UINT DXGI_FORMAT_R16G16B16A16_TYPELESS = 9;
constexpr UINT DXGI_FORMAT_R16G16B16A16_FLOAT = 10;
constexpr UINT DXGI_FORMAT_R16G16B16A16_UNORM = 11;
constexpr UINT DXGI_FORMAT_R16G16B16A16_UINT = 12;
constexpr UINT DXGI_FORMAT_R16G16B16A16_SNORM = 13;
constexpr UINT DXGI_FORMAT_R16G16B16A16_SINT = 14;
constexpr UINT DXGI_FORMAT_R32G32_TYPELESS = 15;
constexpr UINT DXGI_FORMAT_R32G32_FLOAT = 16;
constexpr UINT DXGI_FORMAT_R32G32_UINT = 17;
constexpr UINT DXGI_FORMAT_R32G32_SINT = 18;
constexpr UINT DXGI_FORMAT_R32G8X24_TYPELESS = 19;
constexpr UINT DXGI_FORMAT_D32_FLOAT_S8X24_UINT = 20;
constexpr UINT DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS = 21;
constexpr UINT DXGI_FORMAT_X32_TYPELESS_G8X24_UINT = 22;
constexpr UINT DXGI_FORMAT_R10G10B10A2_TYPELESS = 23;
constexpr UINT DXGI_FORMAT_R10G10B10A2_UNORM = 24;
constexpr UINT DXGI_FORMAT_R10G10B10A2_UINT = 25;
constexpr UINT DXGI_FORMAT_R11G11B10_FLOAT = 26;
constexpr UINT DXGI_FORMAT_R8G8B8A8_TYPELESS = 27;
constexpr UINT DXGI_FORMAT_R8G8B8A8_UNORM = 28;
constexpr UINT DXGI_FORMAT_R8G8B8A8_UNORM_SRGB = 29;
constexpr UINT DXGI_FORMAT_R8G8B8A8_UINT = 30;
constexpr UINT DXGI_FORMAT_R8G8B8A8_SNORM = 31;
constexpr UINT DXGI_FORMAT_R8G8B8A8_SINT = 32;
constexpr UINT DXGI_FORMAT_R16G16_TYPELESS = 33;
constexpr UINT DXGI_FORMAT_R16G16_FLOAT = 34;
constexpr UINT DXGI_FORMAT_R16G16_UNORM = 35;
constexpr UINT DXGI_FORMAT_R16G16_UINT = 36;
constexpr UINT DXGI_FORMAT_R16G16_SNORM = 37;
constexpr UINT DXGI_FORMAT_R16G16_SINT = 38;
constexpr UINT DXGI_FORMAT_R32_TYPELESS = 39;
...
constexpr UINT DXGI_FORMAT_R32_SINT = 43;
constexpr UINT DXGI_FORMAT_R24G8_TYPELESS = 44;
constexpr UINT DXGI_FORMAT_D24_UNORM_S8_UINT = 45;
constexpr UINT DXGI_FORMAT_R24_UNORM_X8_TYPELESS = 46;
constexpr UINT DXGI_FORMAT_X24_TYPELESS_G8_UINT = 47;
constexpr UINT DXGI_FORMAT_R8G8_TYPELESS = 48;
constexpr UINT DXGI_FORMAT_R8G8_UNORM = 49;
constexpr UINT DXGI_FORMAT_R8G8_UINT = 50;
constexpr UINT DXGI_FORMAT_R8G8_SNORM = 51;
constexpr UINT DXGI_FORMAT_R8G8_SINT = 52;
constexpr UINT DXGI_FORMAT_R16_TYPELESS = 53;
constexpr UINT DXGI_FORMAT_R16_FLOAT = 54;
constexpr UINT DXGI_FORMAT_D16_UNORM = 55;
constexpr UINT DXGI_FORMAT_R16_UNORM = 56;
constexpr UINT DXGI_FORMAT_R16_UINT = 57;
constexpr UINT DXGI_FORMAT_R16_SNORM = 58;
constexpr UINT DXGI_FORMAT_R16_SINT = 59;
constexpr UINT DXGI_FORMAT_R8_TYPELESS = 60;
constexpr UINT DXGI_FORMAT_R8_UNORM = 61;
constexpr UINT DXGI_FORMAT_R8_UINT = 62;
constexpr UINT DXGI_FORMAT_R8_SNORM = 63;
constexpr UINT DXGI_FORMAT_R8_SINT = 64;
constexpr UINT DXGI_FORMAT_A8_UNORM = 65;
constexpr UINT DXGI_FORMAT_R9G9B9E5_SHAREDEXP = 67;
constexpr UINT DXGI_FORMAT_BC1_UNORM = 71;
constexpr UINT DXGI_FORMAT_BC1_UNORM_SRGB = 72;
constexpr UINT DXGI_FORMAT_BC2_UNORM = 74;
constexpr UINT DXGI_FORMAT_BC2_UNORM_SRGB = 75;
constexpr UINT DXGI_FORMAT_BC3_UNORM = 77;
constexpr UINT DXGI_FORMAT_BC3_UNORM_SRGB = 78;
constexpr UINT DXGI_FORMAT_BC4_UNORM = 80;
constexpr UINT DXGI_FORMAT_BC4_SNORM = 81;
constexpr UINT DXGI_FORMAT_BC5_UNORM = 83;
constexpr UINT DXGI_FORMAT_BC5_SNORM = 84;
constexpr UINT DXGI_FORMAT_B8G8R8A8_TYPELESS = 90;
constexpr UINT DXGI_FORMAT_B8G8R8A8_UNORM_SRGB = 91;
constexpr UINT DXGI_FORMAT_B8G8R8X8_UNORM = 88;
constexpr UINT DXGI_FORMAT_B8G8R8X8_TYPELESS = 92;
constexpr UINT DXGI_FORMAT_B8G8R8X8_UNORM_SRGB = 93;
constexpr UINT DXGI_FORMAT_BC6H_UF16 = 95;
constexpr UINT DXGI_FORMAT_BC6H_SF16 = 96;
constexpr UINT DXGI_FORMAT_BC7_UNORM = 98;
constexpr UINT DXGI_FORMAT_BC7_UNORM_SRGB = 99;
constexpr UINT DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM = 89;
...
class ID3DBlob : public IUnknown {
  public:
    STDMETHOD_(void*, GetBufferPointer)() PURE;
    STDMETHOD_(SIZE_T, GetBufferSize)() PURE;
};
