/*** Autogenerated by WIDL 7.7 from include/d3d12.idl - Do not edit ***/
...
DEFINE_GUID(IID_ID3D12Resource1, 0x9d5e227a, 0x4430, 0x416e, 0x88,0xb4,0x22,0xd3,0x8f,0x53,0x71,0xd1);
DEFINE_GUID(IID_ID3D12Resource2, 0xbe1d0c32, 0x7e1c, 0x4707, 0xa4,0xf6,0xf5,0xe6,0xc2,0x56,0xbf,0x42);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
typedef struct ID3D12Device2Vtbl {
    BEGIN_INTERFACE
    HRESULT (STDMETHODCALLTYPE *QueryInterface)(ID3D12Device2 *This, REFIID riid, void **ppvObject);
    ULONG (STDMETHODCALLTYPE *AddRef)(ID3D12Device2 *This);
    ULONG (STDMETHODCALLTYPE *Release)(ID3D12Device2 *This);
    HRESULT (STDMETHODCALLTYPE *GetPrivateData)(ID3D12Device2 *This, REFGUID guid, UINT *data_size, void *data);
    HRESULT (STDMETHODCALLTYPE *SetPrivateData)(ID3D12Device2 *This, REFGUID guid, UINT data_size, const void *data);
    HRESULT (STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D12Device2 *This, REFGUID guid, const IUnknown *data);
    HRESULT (STDMETHODCALLTYPE *SetName)(ID3D12Device2 *This, const WCHAR *name);
    UINT (STDMETHODCALLTYPE *GetNodeCount)(ID3D12Device2 *This);
    HRESULT (STDMETHODCALLTYPE *CreateCommandQueue)(ID3D12Device2 *This, const D3D12_COMMAND_QUEUE_DESC *desc, REFIID riid, void **command_queue);
    HRESULT (STDMETHODCALLTYPE *CreateCommandAllocator)(ID3D12Device2 *This, D3D12_COMMAND_LIST_TYPE type, REFIID riid, void **command_allocator);
    HRESULT (STDMETHODCALLTYPE *CreateGraphicsPipelineState)(ID3D12Device2 *This, const D3D12_GRAPHICS_PIPELINE_STATE_DESC *desc, REFIID riid, void **pipeline_state);
    HRESULT (STDMETHODCALLTYPE *CreateComputePipelineState)(ID3D12Device2 *This, const D3D12_COMPUTE_PIPELINE_STATE_DESC *desc, REFIID riid, void **pipeline_state);
    HRESULT (STDMETHODCALLTYPE *CreateCommandList)(ID3D12Device2 *This, UINT node_mask, D3D12_COMMAND_LIST_TYPE type, ID3D12CommandAllocator *command_allocator, ID3D12PipelineState *initial_pipeline_state, REFIID riid, void **command_list);
    HRESULT (STDMETHODCALLTYPE *CheckFeatureSupport)(ID3D12Device2 *This, D3D12_FEATURE feature, void *feature_data, UINT feature_data_size);
    HRESULT (STDMETHODCALLTYPE *CreateDescriptorHeap)(ID3D12Device2 *This, const D3D12_DESCRIPTOR_HEAP_DESC *desc, REFIID riid, void **descriptor_heap);
    UINT (STDMETHODCALLTYPE *GetDescriptorHandleIncrementSize)(ID3D12Device2 *This, D3D12_DESCRIPTOR_HEAP_TYPE descriptor_heap_type);
    HRESULT (STDMETHODCALLTYPE *CreateRootSignature)(ID3D12Device2 *This, UINT node_mask, const void *bytecode, SIZE_T bytecode_length, REFIID riid, void **root_signature);
    void (STDMETHODCALLTYPE *CreateConstantBufferView)(ID3D12Device2 *This, const D3D12_CONSTANT_BUFFER_VIEW_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CreateShaderResourceView)(ID3D12Device2 *This, ID3D12Resource *resource, const D3D12_SHADER_RESOURCE_VIEW_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CreateUnorderedAccessView)(ID3D12Device2 *This, ID3D12Resource *resource, ID3D12Resource *counter_resource, const D3D12_UNORDERED_ACCESS_VIEW_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CreateRenderTargetView)(ID3D12Device2 *This, ID3D12Resource *resource, const D3D12_RENDER_TARGET_VIEW_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CreateDepthStencilView)(ID3D12Device2 *This, ID3D12Resource *resource, const D3D12_DEPTH_STENCIL_VIEW_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CreateSampler)(ID3D12Device2 *This, const D3D12_SAMPLER_DESC *desc, D3D12_CPU_DESCRIPTOR_HANDLE descriptor);
    void (STDMETHODCALLTYPE *CopyDescriptors)(ID3D12Device2 *This, UINT dst_descriptor_range_count, const D3D12_CPU_DESCRIPTOR_HANDLE *dst_descriptor_range_offsets, const UINT *dst_descriptor_range_sizes, UINT src_descriptor_range_count, const D3D12_CPU_DESCRIPTOR_HANDLE *src_descriptor_range_offsets, const UINT *src_descriptor_range_sizes, D3D12_DESCRIPTOR_HEAP_TYPE descriptor_heap_type);
    void (STDMETHODCALLTYPE *CopyDescriptorsSimple)(ID3D12Device2 *This, UINT descriptor_count, D3D12_CPU_DESCRIPTOR_HANDLE dst_descriptor_range_offset, D3D12_CPU_DESCRIPTOR_HANDLE src_descriptor_range_offset, D3D12_DESCRIPTOR_HEAP_TYPE descriptor_heap_type);
    D3D12_RESOURCE_ALLOCATION_INFO *(STDMETHODCALLTYPE *GetResourceAllocationInfo)(ID3D12Device2 *This, D3D12_RESOURCE_ALLOCATION_INFO *__ret, UINT visible_mask, UINT resource_desc_count, const D3D12_RESOURCE_DESC *resource_descs);
    D3D12_HEAP_PROPERTIES *(STDMETHODCALLTYPE *GetCustomHeapProperties)(ID3D12Device2 *This, D3D12_HEAP_PROPERTIES *__ret, UINT node_mask, D3D12_HEAP_TYPE heap_type);
    HRESULT (STDMETHODCALLTYPE *CreateCommittedResource)(ID3D12Device2 *This, const D3D12_HEAP_PROPERTIES *heap_properties, D3D12_HEAP_FLAGS heap_flags, const D3D12_RESOURCE_DESC *desc, D3D12_RESOURCE_STATES initial_state, const D3D12_CLEAR_VALUE *optimized_clear_value, REFIID riid, void **resource);
    HRESULT (STDMETHODCALLTYPE *CreateHeap)(ID3D12Device2 *This, const D3D12_HEAP_DESC *desc, REFIID riid, void **heap);
    HRESULT (STDMETHODCALLTYPE *CreatePlacedResource)(ID3D12Device2 *This, ID3D12Heap *heap, UINT64 heap_offset, const D3D12_RESOURCE_DESC *desc, D3D12_RESOURCE_STATES initial_state, const D3D12_CLEAR_VALUE *optimized_clear_value, REFIID riid, void **resource);
    HRESULT (STDMETHODCALLTYPE *CreateReservedResource)(ID3D12Device2 *This, const D3D12_RESOURCE_DESC *desc, D3D12_RESOURCE_STATES initial_state, const D3D12_CLEAR_VALUE *optimized_clear_value, REFIID riid, void **resource);
    HRESULT (STDMETHODCALLTYPE *CreateSharedHandle)(ID3D12Device2 *This, ID3D12DeviceChild *object, const SECURITY_ATTRIBUTES *attributes, DWORD access, const WCHAR *name, HANDLE *handle);
    HRESULT (STDMETHODCALLTYPE *OpenSharedHandle)(ID3D12Device2 *This, HANDLE handle, REFIID riid, void **object);
    HRESULT (STDMETHODCALLTYPE *OpenSharedHandleByName)(ID3D12Device2 *This, const WCHAR *name, DWORD access, HANDLE *handle);
    HRESULT (STDMETHODCALLTYPE *MakeResident)(ID3D12Device2 *This, UINT object_count, ID3D12Pageable *const *objects);
    HRESULT (STDMETHODCALLTYPE *Evict)(ID3D12Device2 *This, UINT object_count, ID3D12Pageable *const *objects);
    HRESULT (STDMETHODCALLTYPE *CreateFence)(ID3D12Device2 *This, UINT64 initial_value, D3D12_FENCE_FLAGS flags, REFIID riid, void **fence);
    HRESULT (STDMETHODCALLTYPE *GetDeviceRemovedReason)(ID3D12Device2 *This);
    void (STDMETHODCALLTYPE *GetCopyableFootprints)(ID3D12Device2 *This, const D3D12_RESOURCE_DESC *desc, UINT first_sub_resource, UINT sub_resource_count, UINT64 base_offset, D3D12_PLACED_SUBRESOURCE_FOOTPRINT *layouts, UINT *row_count, UINT64 *row_size, UINT64 *total_bytes);
    HRESULT (STDMETHODCALLTYPE *CreateQueryHeap)(ID3D12Device2 *This, const D3D12_QUERY_HEAP_DESC *desc, REFIID riid, void **heap);
    HRESULT (STDMETHODCALLTYPE *SetStablePowerState)(ID3D12Device2 *This, WINBOOL enable);
    HRESULT (STDMETHODCALLTYPE *CreateCommandSignature)(ID3D12Device2 *This, const D3D12_COMMAND_SIGNATURE_DESC *desc, ID3D12RootSignature *root_signature, REFIID riid, void **command_signature);
    void (STDMETHODCALLTYPE *GetResourceTiling)(ID3D12Device2 *This, ID3D12Resource *resource, UINT *total_tile_count, D3D12_PACKED_MIP_INFO *packed_mip_info, D3D12_TILE_SHAPE *standard_tile_shape, UINT *sub_resource_tiling_count, UINT first_sub_resource_tiling, D3D12_SUBRESOURCE_TILING *sub_resource_tilings);
    LUID *(STDMETHODCALLTYPE *GetAdapterLuid)(ID3D12Device2 *This, LUID *__ret);
    HRESULT (STDMETHODCALLTYPE *CreatePipelineLibrary)(ID3D12Device2 *This, const void *blob, SIZE_T blob_size, REFIID iid, void **lib);
    HRESULT (STDMETHODCALLTYPE *SetEventOnMultipleFenceCompletion)(ID3D12Device2 *This, ID3D12Fence *const *fences, const UINT64 *values, UINT fence_count, D3D12_MULTIPLE_FENCE_WAIT_FLAGS flags, HANDLE event);
    HRESULT (STDMETHODCALLTYPE *SetResidencyPriority)(ID3D12Device2 *This, UINT object_count, ID3D12Pageable *const *objects, const D3D12_RESIDENCY_PRIORITY *priorities);
    HRESULT (STDMETHODCALLTYPE *CreatePipelineState)(ID3D12Device2 *This, const D3D12_PIPELINE_STATE_STREAM_DESC *desc, REFIID riid, void **ppPipelineState);
    END_INTERFACE
} ID3D12Device2Vtbl;
interface ID3D12Device2 {
